...
object EngineParamsList extends EngineParamsGenerator {
  ...
  engineParamsList = Seq(
    baseEP.copy(algorithmParamsList = Seq(("VWlogisticSGD", AlgorithmParams(10, 0.1, 1.0, 1, "model.vw", "n")))),
    baseEP.copy(algorithmParamsList = Seq(("VWlogisticSGD", AlgorithmParams(100, 0.01, 1.0, 1, "model.vw", "n")))),
    baseEP.copy(algorithmParamsList = Seq(("VWlogisticSGD", AlgorithmParams(1, 0.1, 1.0, 1, "model.vw", "n")))))
}
